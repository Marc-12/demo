...
<h2>Espace d'administration</h2><p>Créez, modifier ou effacez des articles, modérez les commentaires de vos lecteurs</p><br/>
	<button class="buttoncreatePost">+</button><p>créez un nouvel article</p>
...
<div class="DivCreatePost">												
	...
	<?php	
		//foreach ($post2Update as $data2Update)
		//{
	?>							
			<form class="adminUpdatePost" action="" method="POST" enctype="multipart/form-data">
				...
				<div>
					<label for="title">Contenu de l'article: </label><br/>
					<textarea class="DivTinyMceUpdate" name="content"></textarea>
				</div>
				<div>
					<input type="submit" value="Valider"/>
				</div>
	...
	<script>tinymce.init({selector:'.DivTinyMceUpdate'});</script>
